...
#  Apr 22, 2019 01:28:33 AM +0530  platform: Windows NT
set vTcl(timestamp) ""
...
vTcl:font:add_font \
    "-family {Berlin Sans FB} -size 15 -weight normal -slant roman -underline 0 -overstrike 0" \
    user \
    vTcl:font17
#################################
#LIBRARY PROCEDURES
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 1600x837+6+194
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    entry $top.ent43 \
        ...
        -foreground {#1b1391} -insertbackground black 
    vTcl:DefineAlias "$top.ent43" "villagename" vTcl:WidgetProc "Toplevel1" 1
    entry $top.ent44 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
    ...
    label $top.lab54 \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font {-family {Berlin Sans FB} -size 15} -foreground {#000000} \
        -text {Village Name :} 
    ...
    label $top.lab55 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {UID Number  :} 
    vTcl:DefineAlias "$top.lab55" "Label7_1" vTcl:WidgetProc "Toplevel1" 1
    button $top.but56 \
        -activebackground {#ececec} -activeforeground {#000000} \
        -background {#ff330a} -disabledforeground {#a3a3a3} \
        -font {-family {Rockwell Extra Bold} -size 12 -weight bold} \
        -foreground {#fcffff} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text FIND 
    vTcl:DefineAlias "$top.but56" "btn_find" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab43 \
    ...
    place $top.fra43 \
        ...
        -anchor nw -bordermode ignore 
    place $top.ent43 \
        -in $top -x 600 -y 150 -width 244 -relwidth 0 -height 20 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.ent44 \
        -in $top -x 1080 -y 150 -width 234 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab54 \
        -in $top -x 430 -y 150 -width 154 -relwidth 0 -height 21 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab55 \
        -in $top -x 920 -y 150 -width 154 -relwidth 0 -height 21 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but56 \
        -in $top -x 1370 -y 140 -width 97 -relwidth 0 -height 34 -relheight 0 \
        -anchor nw -bordermode ignore 
