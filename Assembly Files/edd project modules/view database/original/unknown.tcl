...
#  May 10, 2019 09:21:06 AM +0530  platform: Windows NT
set vTcl(timestamp) ""
...
foreach img {
        ...
        {{[file join V:/ {edd project 2019 jan} {edd project modules} {view database} original login3.png]} {user image} user {}}
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 1600x837+47+-14
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab49 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join V:/ {edd project 2019 jan} {edd project modules} {view database} original login3.png]] \
        -text Label 
    ...
    button $top.but44 \
        -activebackground {#ececec} -activeforeground {#000000} \
        -background {#ff0d0d} -disabledforeground {#a3a3a3} \
        -font {-family {Rockwell} -size 13 -weight bold} \
        -foreground {#ffffff} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -takefocus 0 -text {VIEW TOTAL} 
    vTcl:DefineAlias "$top.but44" "viewtotal" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab43 \
    ...
    place $top.fra43 \
        ...
        -anchor nw -bordermode ignore 
    place $top.but44 \
        -in $top -x 1350 -y 140 -width 158 -relwidth 0 -height 53 \
        -relheight 0 -anchor nw -bordermode ignore 
