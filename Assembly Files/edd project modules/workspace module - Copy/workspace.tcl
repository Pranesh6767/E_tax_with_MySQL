...
#  Mar 28, 2019 07:30:55 PM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    label $site_3_0.lab45 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Housetax(Paid) :} 
    vTcl:DefineAlias "$site_3_0.lab45" "Label7_2" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab46 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#50e82a} -disabledforeground {#a3a3a3} \
        -font {-family {Plantagenet Cherokee} -size 13} -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Healthtax (Paid) :} 
    vTcl:DefineAlias "$site_3_0.lab46" "Label7_3" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab47 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#50e82a} -disabledforeground {#a3a3a3} \
        -font {-family {Plantagenet Cherokee} -size 13} -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Lighttax(Paid) :} 
    vTcl:DefineAlias "$site_3_0.lab47" "Label7_4" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab48 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#50e82a} -disabledforeground {#a3a3a3} \
        -font {-family {Plantagenet Cherokee} -size 13} -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Watertax(Paid) :} 
    vTcl:DefineAlias "$site_3_0.lab48" "Label7_5" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab49 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#50e82a} -disabledforeground {#a3a3a3} \
        -font {-family {Plantagenet Cherokee} -size 13} -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Total (Paid) :} 
    vTcl:DefineAlias "$site_3_0.lab49" "Label7_6" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent60 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
    ...
    label $top.lab54 \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} -text {ID Number} 
    vTcl:DefineAlias "$top.lab54" "Label9" vTcl:WidgetProc "Toplevel1" 1
    frame $top.fra55 \
        -borderwidth 10 -relief ridge -background {#50e82a} -height 115 \
        -width 305 
    ...
    label $site_3_0.lab57 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text -----Email----- 
    vTcl:DefineAlias "$site_3_0.lab57" "Label8_8" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.lab58" "Label7_9" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent59 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black 
    vTcl:DefineAlias "$site_3_0.ent59" "txt_findid_10" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.lab57 \
        -in $site_3_0 -x 70 -y 10 -width 168 -height 27 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab58 \
        -in $site_3_0 -x 10 -y 30 -width 286 -relwidth 0 -height 29 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent59 \
        -in $site_3_0 -x 20 -y 70 -width 264 -relwidth 0 -height 20 \
        -relheight 0 -anchor nw -bordermode ignore 
    label $top.lab61 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Name 
    vTcl:DefineAlias "$top.lab61" "Label9_11" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab62 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text {ID No.} 
    vTcl:DefineAlias "$top.lab62" "Label9_12" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab63 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Meter No.} 
    vTcl:DefineAlias "$top.lab63" "Label9_13" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab64 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text {Ward No.} 
    vTcl:DefineAlias "$top.lab64" "Label9_13" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab65 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Houseatax 
    vTcl:DefineAlias "$top.lab65" "Label9_13" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab66 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text Healthtaxtax 
    vTcl:DefineAlias "$top.lab66" "Label9_14" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab67 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Lighttax 
    vTcl:DefineAlias "$top.lab67" "Label9_14" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab68 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Watertax 
    vTcl:DefineAlias "$top.lab68" "Label9_14" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab69 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#ffff24} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Toatal 
    vTcl:DefineAlias "$top.lab69" "Label9_14" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab43 \
    ...
    place $top.fra43 \
        -in $top -x 0 -y 230 -width 305 -relwidth 0 -height 425 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra77 \
    ...
    place $top.fra78 \
        ...
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab54 \
        -in $top -x 620 -y 210 -anchor nw -bordermode ignore 
    place $top.fra55 \
        -in $top -x 0 -y 660 -width 305 -relwidth 0 -height 115 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab61 \
        -in $top -x 730 -y 210 -width 64 -height 21 -anchor nw \
        -bordermode ignore 
    place $top.lab62 \
        -in $top -x 1000 -y 220 -width 54 -relwidth 0 -height 11 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab63 \
        -in $top -x 1070 -y 220 -width 54 -height 11 -anchor nw \
        -bordermode ignore 
    place $top.lab64 \
        -in $top -x 1140 -y 220 -width 54 -relwidth 0 -height 11 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab65 \
        -in $top -x 1200 -y 220 -width 64 -relwidth 0 -height 11 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab66 \
        -in $top -x 1270 -y 220 -width 64 -height 11 -anchor nw \
        -bordermode ignore 
    place $top.lab67 \
        -in $top -x 1340 -y 220 -width 54 -relwidth 0 -height 11 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab68 \
        -in $top -x 1400 -y 220 -width 64 -height 11 -anchor nw \
        -bordermode ignore 
    place $top.lab69 \
        -in $top -x 1460 -y 220 -width 64 -height 11 -anchor nw \
        -bordermode ignore 
